...
class MainFrame(ToolFrame):
    def __init__(self, parent: wx.Window | None = None, *args, **kw):
        ...
        input_file_sizer.Add(
            wx.StaticText(input_file_panel, label="連続画像に展開する動画ファイル:"),
        ...
        input_video_sizer.Add(
            wx.StaticText(
                input_video_panel,
                label="赤い▲をドラッグして、画像のフレームを指定できます。",
            ),
    ...
    def __make_control_panel(self, parent):
        ...
        sizer.Add(
            self.input_video_histogram_view, flag=wx.EXPAND | wx.BOTTOM, border=MARGIN
        )
        ...
        self.info_frame = wx.StaticText(
            info_panel, label="", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
        )
        info_sizer.Add(self.info_frame, flag=wx.EXPAND | wx.RIGHT, border=MARGIN)
        info_sizer.Add(
            wx.StaticText(
                info_panel, label="R:", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND,
        )
        self.info_r = wx.StaticText(
            info_panel, label="", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
        )
        info_sizer.Add(self.info_r, flag=wx.EXPAND | wx.RIGHT, border=MARGIN)
        info_sizer.Add(
            wx.StaticText(
                info_panel, label="X:", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND,
        )
        self.info_x = wx.StaticText(
            info_panel, label="", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
        )
        info_sizer.Add(self.info_x, flag=wx.EXPAND | wx.RIGHT, border=MARGIN)
        info_sizer.Add(
            wx.StaticText(
                info_panel, label="G:", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND,
        )
        self.info_g = wx.StaticText(
            info_panel, label="", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
        )
        info_sizer.Add(self.info_g, flag=wx.EXPAND | wx.RIGHT, border=MARGIN)
        info_sizer.Add(
            wx.StaticText(
                info_panel, label="Y:", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND,
        )
        self.info_y = wx.StaticText(
            info_panel, label="", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
        )
        info_sizer.Add(self.info_y, flag=wx.EXPAND | wx.RIGHT, border=MARGIN)
        info_sizer.Add(
            wx.StaticText(
                info_panel, label="B:", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND,
        )
        self.info_b = wx.StaticText(
            info_panel, label="", style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE
        )
        ...
        for l, n in (("0°", "0"), ("90°", "90"), ("180°", "180"), ("270°", "270")):
            rotation_button = wx.RadioButton(
                rotation_panel, label=l, name=n, style=style
            )
        ...
        color_eq_sizer.Add(
            wx.StaticText(
                color_eq_panel, label="brightness:", style=wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_eq_sizer.Add(
            wx.StaticText(color_eq_panel, label="contrast:", style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_eq_sizer.Add(
            wx.StaticText(color_eq_panel, label="gamma:", style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_eq_sizer.Add(
            wx.StaticText(
                color_eq_panel, label="saturation:", style=wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        self.eq_brightness = wx.SpinCtrlDouble(
            color_eq_panel,
            value="0.00",
            min=-1.0,
            max=1.0,
        ...
        self.eq_contrast = wx.SpinCtrlDouble(
            color_eq_panel,
            value="1.00",
            min=-1000.0,
            max=1000.0,
        ...
        self.eq_gamma = wx.SpinCtrlDouble(
            color_eq_panel,
            value="1.00",
            min=0.1,
            max=10.0,
        ...
        self.eq_saturation = wx.SpinCtrlDouble(
            color_eq_panel,
            value="1.00",
            min=0.1,
            max=3.0,
        ...
        self.colortemperature_button = wx.ToggleButton(
            color_adjustment_panel, label="colortemperature"
        )
        color_adjustment_sizer.Add(
            self.colortemperature_button, flag=wx.EXPAND | wx.TOP, border=6
        )
        ...
        color_colortemperature_sizer.Add(
            wx.StaticText(
                color_colortemperature_panel,
                label="temperature:",
        ...
        color_colortemperature_sizer.Add(
            wx.StaticText(
                color_colortemperature_panel, label="pl:", style=wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_colortemperature_sizer.Add(
            wx.StaticText(
                color_colortemperature_panel, label="mix:", style=wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        self.colortemperature_temperature = wx.SpinCtrl(
            color_colortemperature_panel,
            value="6500",
            min=1000,
            max=40000,
        ...
        color_colortemperature_sizer.Add(
            self.colortemperature_temperature, flag=wx.EXPAND
        )
        self.colortemperature_pl = wx.SpinCtrlDouble(
            color_colortemperature_panel,
            value="1.00",
            min=0.0,
            max=1.0,
        ...
        self.colortemperature_mix = wx.SpinCtrlDouble(
            color_colortemperature_panel,
            value="1.00",
            min=0.0,
            max=1.0,
        ...
        self.huesaturation_button = wx.ToggleButton(
            color_adjustment_panel, label="huesaturation"
        )
        color_adjustment_sizer.Add(
            self.huesaturation_button, flag=wx.EXPAND | wx.TOP, border=6
        )
        color_huesaturation_panel = wx.Panel(color_adjustment_panel)
        color_huesaturation_sizer = wx.GridSizer(cols=3, gap=wx.Size(4, 2))
        color_huesaturation_sizer.Add(
            wx.StaticText(
                color_huesaturation_panel, label="hue:", style=wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_huesaturation_sizer.Add(
            wx.StaticText(
                color_huesaturation_panel,
                label="saturation:",
                style=wx.ST_NO_AUTORESIZE,
            ),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        ...
        color_huesaturation_sizer.Add(
            wx.StaticText(
                color_huesaturation_panel, label="intensity:", style=wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        self.huesaturation_hue = wx.SpinCtrl(
            color_huesaturation_panel,
            value="0",
            min=-180,
            max=180,
        ...
        self.huesaturation_saturation = wx.SpinCtrlDouble(
            color_huesaturation_panel,
            value="0.00",
            min=-1.0,
            max=1.0,
        ...
        self.huesaturation_intensity = wx.SpinCtrlDouble(
            color_huesaturation_panel,
            value="0.00",
            min=-1.0,
            max=1.0,
        ...
        self.format_png_button = wx.RadioButton(
            output_panel, label="24bit PNG", style=wx.RB_GROUP
        )
        ...
        save_button = wx.Button(
            output_panel, label="連続画像とカタログファイルを作成する..."
        )
        ...
        # event bindings
        self.eq_button.Bind(
            wx.EVT_TOGGLEBUTTON, self.__on_color_adjustment_control_changed
        )
        self.eq_brightness.Bind(wx.EVT_TEXT, self.__on_color_adjustment_changed)
        self.eq_brightness.Bind(
            wx.EVT_SPINCTRLDOUBLE, self.__on_color_adjustment_changed
        )
        ...
        self.eq_saturation.Bind(
            wx.EVT_SPINCTRLDOUBLE, self.__on_color_adjustment_changed
        )

        self.colortemperature_button.Bind(
            wx.EVT_TOGGLEBUTTON, self.__on_color_adjustment_control_changed
        )
        self.colortemperature_temperature.Bind(
            wx.EVT_TEXT, self.__on_color_adjustment_changed
        )
        self.colortemperature_temperature.Bind(
            wx.EVT_SPINCTRL, self.__on_color_adjustment_changed
        )
        self.colortemperature_pl.Bind(wx.EVT_TEXT, self.__on_color_adjustment_changed)
        self.colortemperature_pl.Bind(
            wx.EVT_SPINCTRLDOUBLE, self.__on_color_adjustment_changed
        )
        self.colortemperature_mix.Bind(wx.EVT_TEXT, self.__on_color_adjustment_changed)
        self.colortemperature_mix.Bind(
            wx.EVT_SPINCTRLDOUBLE, self.__on_color_adjustment_changed
        )

        self.huesaturation_button.Bind(
            wx.EVT_TOGGLEBUTTON, self.__on_color_adjustment_control_changed
        )
        ...
        self.huesaturation_saturation.Bind(
            wx.EVT_TEXT, self.__on_color_adjustment_changed
        )
        self.huesaturation_saturation.Bind(
            wx.EVT_SPINCTRLDOUBLE, self.__on_color_adjustment_changed
        )
        self.huesaturation_intensity.Bind(
            wx.EVT_TEXT, self.__on_color_adjustment_changed
        )
        self.huesaturation_intensity.Bind(
            wx.EVT_SPINCTRLDOUBLE, self.__on_color_adjustment_changed
    ...
    def __set_previewer(self, position, filter_complex=None):
        ...
        try:
            ...
            w, h = (
                ...
                if self.probe.rotation % 180
                else (self.probe.width, self.probe.height)
            )
    ...
    def __save_setting(self):
        ...
        setting = dict(
            ...
            colortemperature_temperature=get_spin_ctrl_value(
                self.colortemperature_temperature
            ),
    ...
    def __load_setting(self):
        ...
        self.colortemperature_temperature.SetValue(
            _g(setting, "colortemperature_temperature", "6500")
        )
        ...
        self.huesaturation_saturation.SetValue(
            _g(setting, "huesaturation_saturation", "0.00")
        )
        self.huesaturation_intensity.SetValue(
            _g(setting, "huesaturation_intensity", "0.00")
        )
    ...
    def __load_video(self):
        ...
        self.__load_setting()
        self.input_video_thumbnail.load_video(
            path, self.rotation, self.__make_filter_complex()
        )
    ...
    def __on_save_button_clicked(self, event):
        ...
        output_filename = (
            input_path.stem.removesuffix(RAW_SUFFIX) + "_" + output_format + ".txt"
        )
