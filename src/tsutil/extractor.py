...
class MainFrame(ToolFrame):
    def __init__(self, parent: wx.Window | None = None, *args, **kw):
        ...
        input_file_sizer.Add(
            wx.StaticText(input_file_panel, label='連続画像に展開する動画ファイル:'), flag=wx.ALIGN_CENTER_VERTICAL
        )
        ...
        input_video_sizer.Add(
            wx.StaticText(input_video_panel, label='赤い▲をドラッグして、画像のフレームを指定できます。'),
        ...
        output_file_sizer.Add(
            wx.StaticText(output_file_panel, label='出力した連続画像のカタログファイル:'), flag=wx.ALIGN_CENTER_VERTICAL
        )
    ...
    def __make_control_panel(self, parent):
        ...
        info_sizer.Add(
            wx.StaticText(info_panel, label='フレーム位置:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE), flag=wx.EXPAND
        )
        ...
        info_sizer.Add(
            wx.StaticText(info_panel, label='R:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE), flag=wx.EXPAND
        )
        ...
        info_sizer.Add(
            wx.StaticText(info_panel, label='X:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE), flag=wx.EXPAND
        )
        ...
        info_sizer.Add(
            wx.StaticText(info_panel, label='G:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE), flag=wx.EXPAND
        )
        ...
        info_sizer.Add(
            wx.StaticText(info_panel, label='Y:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE), flag=wx.EXPAND
        )
        ...
        info_sizer.Add(
            wx.StaticText(info_panel, label='B:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE), flag=wx.EXPAND
        )
        ...
        rotation_sizer.Add(
            wx.StaticText(rotation_panel, label='画像展開時の回転:', style=wx.ALIGN_CENTER | wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND,
        )
        style = wx.RB_GROUP
        ...
        color_eq_sizer.Add(
            wx.StaticText(color_eq_panel, label='brightness:', style=wx.ST_NO_AUTORESIZE),
        ...
        color_eq_sizer.Add(
            wx.StaticText(color_eq_panel, label='gamma:', style=wx.ST_NO_AUTORESIZE), flag=wx.EXPAND | wx.ALIGN_BOTTOM
        )
        color_eq_sizer.Add(
            wx.StaticText(color_eq_panel, label='saturation:', style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        self.eq_brightness = wx.SpinCtrlDouble(
            color_eq_panel, value='0.00', min=-1.0, max=1.0, inc=0.01, style=wx.SP_ARROW_KEYS | wx.ALIGN_RIGHT
        )
        color_eq_sizer.Add(self.eq_brightness, flag=wx.EXPAND)
        self.eq_contrast = wx.SpinCtrlDouble(
            color_eq_panel, value='1.00', min=-1000.0, max=1000.0, inc=0.01, style=wx.SP_ARROW_KEYS | wx.ALIGN_RIGHT
        )
        color_eq_sizer.Add(self.eq_contrast, flag=wx.EXPAND)
        self.eq_gamma = wx.SpinCtrlDouble(
            color_eq_panel, value='1.00', min=0.1, max=10.0, inc=0.01, style=wx.SP_ARROW_KEYS | wx.ALIGN_RIGHT
        )
        color_eq_sizer.Add(self.eq_gamma, flag=wx.EXPAND)
        self.eq_saturation = wx.SpinCtrlDouble(
            color_eq_panel, value='1.00', min=0.1, max=3.0, inc=0.01, style=wx.SP_ARROW_KEYS | wx.ALIGN_RIGHT
        )
        ...
        color_colortemperature_sizer.Add(
            wx.StaticText(color_colortemperature_panel, label='temperature:', style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_colortemperature_sizer.Add(
            wx.StaticText(color_colortemperature_panel, label='pl:', style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_colortemperature_sizer.Add(
            wx.StaticText(color_colortemperature_panel, label='mix:', style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        self.colortemperature_temperature = wx.SpinCtrl(
            color_colortemperature_panel, value='6500', min=1000, max=40000, style=wx.SP_ARROW_KEYS | wx.ALIGN_RIGHT
        )
        ...
        color_huesaturation_sizer.Add(
            wx.StaticText(color_huesaturation_panel, label='hue:', style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_huesaturation_sizer.Add(
            wx.StaticText(color_huesaturation_panel, label='saturation:', style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        color_huesaturation_sizer.Add(
            wx.StaticText(color_huesaturation_panel, label='intensity:', style=wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_BOTTOM,
        )
        self.huesaturation_hue = wx.SpinCtrl(
            color_huesaturation_panel, value='0', min=-180, max=180, style=wx.SP_ARROW_KEYS | wx.ALIGN_RIGHT
        )
            ...
            if filter_complex:
                for k, v in filter_complex.items():
                    if type(v) is dict:
                        ...
                        stream = stream.filter_(k, v)
            out, err = (
                stream.output('pipe:', format='rawvideo', pix_fmt='rgb24', loglevel='error', **{'frames:v': 1})
                .overwrite_output()
