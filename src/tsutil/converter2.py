...
class MainFrame(ToolFrame):
    def __init__(self, parent: wx.Window | None = None, *args, **kw):
        ...
        output_file_sizer.Add(
            wx.StaticText(output_file_panel, label='調整後のステッチング画像ファイル:'), flag=wx.ALIGN_CENTER_VERTICAL
        )
    ...
    def __make_setting_panel(self, parent):
        ...
        preview_sizer.Add(
            wx.StaticText(preview_panel, label='動画で表示したい場所:', style=wx.ALIGN_LEFT | wx.ST_NO_AUTORESIZE),
        ...
        option1_sizer.Add(
            wx.StaticText(option1_panel, label='中心X:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        option1_sizer.Add(
            wx.StaticText(option1_panel, label='中心Y:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        option1_sizer.Add(
            wx.StaticText(option1_panel, label='幅:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        option2_sizer.Add(
            wx.StaticText(option2_panel, label='初速:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        option2_sizer.Add(
            wx.StaticText(option2_panel, label='終速:', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        option2_sizer.Add(
            wx.StaticText(option2_panel, label='遷移(秒):', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        self.seq_trans_t = wx.SpinCtrlDouble(
            option2_panel, value='3.0', min=0.0, max=100.0, inc=0.1, style=wx.SP_ARROW_KEYS | wx.ALIGN_RIGHT
        )
        option2_sizer.Add(self.seq_trans_t, flag=wx.RIGHT, border=8)
        option2_sizer.Add(
            wx.StaticText(option2_panel, label='静止(秒):', style=wx.ALIGN_RIGHT | wx.ST_NO_AUTORESIZE),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        self.seq_still_t = wx.SpinCtrlDouble(
            option2_panel, value='2.0', min=0.0, max=100.0, inc=0.1, style=wx.SP_ARROW_KEYS | wx.ALIGN_RIGHT
        )
        ...
        setting_sizer.Add(
            wx.StaticText(
                setting_panel, label='動画で表示したい場所のリスト:', style=wx.ALIGN_LEFT | wx.ST_NO_AUTORESIZE
            ),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        row = 1
    ...
    def __render_buf(self, image_x, image_y, image_w):
        ...
        self.buf[buf_y0:buf_y1, buf_x0:buf_x1, :] = cv2.resize(
            src[img_y0:img_y1, img_x0:img_x1, :], (_w2, _h2), interpolation=cv2.INTER_AREA
        )
