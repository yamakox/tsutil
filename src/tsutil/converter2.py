...
class MainFrame(ToolFrame):
    ...
    def __make_setting_panel(self, parent):
        ...
        self.sequence_list = wx.ListCtrl(setting_panel, size=parent.FromDIP(wx.Size(*SEQUENCE_LIST_SIZE)), style=wx.LC_REPORT|wx.LC_SINGLE_SEL)
        self.sequence_list.InsertColumn(0, '中心X', wx.LIST_FORMAT_RIGHT, width=70)
        self.sequence_list.InsertColumn(1, '中心Y', wx.LIST_FORMAT_RIGHT, width=70)
        self.sequence_list.InsertColumn(2, '幅', wx.LIST_FORMAT_RIGHT, width=70)
        self.sequence_list.InsertColumn(3, '初速', wx.LIST_FORMAT_CENTER, width=60)
        self.sequence_list.InsertColumn(4, '終速', wx.LIST_FORMAT_CENTER, width=60)
        self.sequence_list.InsertColumn(5, '遷移(秒)', wx.LIST_FORMAT_RIGHT, width=70)
        self.sequence_list.InsertColumn(6, '静止(秒)', wx.LIST_FORMAT_RIGHT, width=70)
